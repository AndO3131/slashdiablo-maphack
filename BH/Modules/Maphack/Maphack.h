...
class Maphack : public Module {
	private:
		...
		std::map<wstring, wstring> MonsterColors;
		std::map<wstring, wstring> SuperUniqueColors;
		std::map<wstring, wstring> MonsterLines;
		std::map<wstring, wstring> MonsterHides;
		std::map<string, unsigned int> TextColorMap; 
		std::map<wstring, unsigned int> monsterColors;
		std::map<wstring, unsigned int> missileColors;
